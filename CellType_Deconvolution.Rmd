...
# Run cibersort
cibersort <- CIBERSORT(sig_matrix = lm22, mixture_file = as.data.frame(NormByTPM), perm = 1000, QN = T, absolute = F) # absolute=T, abs_method = "sig.score"                            #better wiht counts (jin liu et al 2021)
...
# Run MCPcounter
mcpres <- MCPcounter.estimate(TMM,
